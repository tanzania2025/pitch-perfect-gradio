...
# Example scripts
EXAMPLE_SCRIPTS = {
    "Professional Script": """Good morning, team. Today I'd like to discuss our quarterly performance. Our revenue has increased by fifteen percent, demonstrating our customer-centric approach's effectiveness. We'll focus on three key areas: enhancing digital infrastructure, expanding market presence, and investing in employee development. These initiatives will position us competitively while ensuring sustainable growth. The data shows promising trends in customer satisfaction, validating our strategic direction.""",

    "Funny Script": """So I went to the grocery store yesterday, and it's like entering a parallel universe where common sense goes to die. I spent ten minutes looking for milk, which apparently relocated itself. Then I encountered the self-checkout machine, designed by someone who's never bought groceries. It kept yelling at me for unexpected items while I argued with a machine about whether my bananas are actually bananas. Technology – making simple tasks complicated since forever!""",

    "Casual Script": """Hey everyone! Hope you're doing well. I wanted to share something cool from this week. I finally took that cooking class I'd been putting off for months. I was nervous at first because I can barely make toast without setting off the smoke alarm. But it was amazing! The instructor was patient, and I learned to make incredible pasta from scratch. The best part was meeting other people just as clueless as me in the kitchen.""",

    "Presentation Script": """Welcome to our overview of sustainable energy solutions for modern businesses. Climate change represents one of our most pressing challenges, and organizations must adapt to meet evolving environmental standards. Today we'll explore renewable energy adoption, energy efficiency optimization, and carbon footprint reduction. Research shows companies investing in sustainable practices experience significant cost savings while enhancing brand reputation. We'll provide actionable recommendations for your organization's energy future.""",

    "Storytelling Script": """Once upon a time, in a village between rolling hills and whispering forests, lived an old clockmaker named Henrik. His workshop was filled with gently ticking timepieces, each telling its own story. One autumn morning, Henrik discovered something extraordinary – a clock that ticked backwards. With each backward tick, he could glimpse fragments of memories from days gone by. Henrik realized this magical clock was preserving the beautiful tapestry of human experience."""
}
